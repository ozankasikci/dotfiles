...
call s:highlight("SpecialKey", "NONE", 4, "NONE")

"call s:highlight("Cursor", 0, 7, "reverse")
call s:highlight("LineNr", 237, 0, "NONE")
call s:highlight("VertSplit", 8, "NONE", "NONE")
call s:highlight("StatusLine", 8, 234, "NONE")
call s:highlight("StatusLineNC", 0, 238, "NONE")
...
" Syntax highlighting
call s:highlight("Comment", 238, "NONE", "NONE")
call s:highlight("String", 11, "NONE", "NONE")
