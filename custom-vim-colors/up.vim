...
hi Identifier      guifg=#b1d631                   gui=NONE            ctermfg=96
hi Function        guifg=#B7EF52                   gui=NONE            ctermfg=255
hi Type            guifg=#81C7FF                   gui=NONE            ctermfg=149
hi Typedef         guifg=#7AFFFD                   gui=NONE            ctermfg=109
hi StorageClass    guifg=#7AFFFD                   gui=NONE            ctermfg=109
hi Statement       guifg=#7AFFFD                   gui=NONE            ctermfg=109
hi Keyword         guifg=#ff9800                   gui=NONE            ctermfg=208
hi Constant        guifg=#14F2E7                   gui=NONE            ctermfg=208
hi Number          guifg=#FEFFD5                   gui=NONE            ctermfg=208
hi Special         guifg=#ff9800                   gui=NONE            ctermfg=208
hi PreProc         guifg=#faf4c6                   gui=NONE            ctermfg=59
hi Define          guifg=#7AFFFD                   gui=NONE            ctermfg=230

hi String          guifg=#8cd9a2   guibg=NONE      gui=NONE            ctermfg=185
