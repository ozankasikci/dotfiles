...
" hi Special ctermfg=lightgray ctermbg=none
    ...
    " General
    hi Normal ctermfg=255 guifg=#FFFFFF ctermbg=233 guibg=#060606 cterm=none gui=none
    ...
    hi LineNr ctermbg=232 guibg=#060606 ctermfg=236 guifg=#3d464c cterm=none gui=none
